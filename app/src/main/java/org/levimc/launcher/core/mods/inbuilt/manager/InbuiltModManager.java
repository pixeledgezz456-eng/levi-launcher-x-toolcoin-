...
public class InbuiltModManager {
    ...
    private static final String KEY_INJECT_CAPES = "inject_capes";
    private static final String KEY_INJECT_ENTITLEMENT = "inject_entitlement";
    private static final String KEY_INJECT_COSMOS = "inject_bionic_capes";
    private static final String KEY_UNLOCK_PERSONA = "unlock_all_persona";
    ...
    public boolean isInjectCapesEnabled() {
        return prefs.getBoolean(KEY_INJECT_CAPES, true);
    }

    public void setInjectCapesEnabled(boolean enabled) {
        prefs.edit().putBoolean(KEY_INJECT_CAPES, enabled).apply();
    }

    public boolean isUnlockPersonaEnabled(){
        return prefs.getBoolean(KEY_UNLOCK_PERSONA, false);
    }

    public void setUnlockPersonaEnabled(boolean enabled){
        prefs.edit().putBoolean(KEY_UNLOCK_PERSONA, enabled).apply();
    }

    public boolean isInjectCosmosEnabled(){
        return prefs.getBoolean(KEY_INJECT_COSMOS, false);
    }

    public void setInjectCosmosEnabled(boolean enabled) {
        prefs.edit().putBoolean(KEY_INJECT_COSMOS, enabled).apply();
    }


    public boolean isInjectEntitlementEnabled() {
        return prefs.getBoolean(KEY_INJECT_ENTITLEMENT, true);
    }

    public void setInjectEntitlementEnabled(boolean enabled) {
        prefs.edit().putBoolean(KEY_INJECT_ENTITLEMENT, enabled).apply();
    }
